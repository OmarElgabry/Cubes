...
| Swapping Sort | Sort an array by swapping. _Swap between only adjacent elements and between any elements_. | ```Input:```<br> {3, 1, 0, 1, 4, 8, 11, 4, 34, 2} <br> ```Output:``` <br>  {0, 1, 1, 2, 3, 4, 4, 8, 11, 34} | O(N^2) | [B. Little Robber Girl's Zoo](http://codeforces.com/contest/686/problem/B)
